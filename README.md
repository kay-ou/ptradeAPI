...
> 如果你希望在本地环境中进行策略验证或原型开发，可以参考我的另一个开源项目 SimTradeLab。它模拟了 PTrade 的事件驱动机制和接口风格，具备独立实现与扩展能力，适合教学、研究及快速迭代测试使用，本地回测速度相比ptrade提高20-30+倍！ github.com/kay-ou/SimTradeLab
